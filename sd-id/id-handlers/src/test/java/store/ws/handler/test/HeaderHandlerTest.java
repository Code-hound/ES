...
import store.ws.handler.ClientHeaderHandler;
import org.w3c.dom.*;
...
public class HeaderHandlerTest extends AbstractHandlerTest {
    ...
    public void testHeaderHandlerOutbound(
        ...
        ClientHeaderHandler handler = new ClientHeaderHandler();
    ...
    public void testHeaderHandlerInbound(
        ...
        new StrictExpectations() {{
            ...
            soapMessageContext.put(ClientHeaderHandler.CONTEXT_PROPERTY, 22);
            soapMessageContext.setScope(ClientHeaderHandler.CONTEXT_PROPERTY, Scope.APPLICATION);
        }};
