...
public class PermissionTests {
	...
	private static String[] string_levels = {"none", "root", "owner", "writer", "reader", "mom", "dog", "1", "Shrek", "itsallogrenow"};
	...
	public void checkIntPermissionsLevel () {
		assertEquals(Integer.toString(int_permissions.get(0).getPermissionLevel()), "0");
		assertEquals(Integer.toString(int_permissions.get(1).getPermissionLevel()), "1");
		assertEquals(Integer.toString(int_permissions.get(2).getPermissionLevel()), "2");
		assertEquals(Integer.toString(int_permissions.get(3).getPermissionLevel()), "3");
		assertEquals(Integer.toString(int_permissions.get(4).getPermissionLevel()), "4");
		assertEquals(Integer.toString(int_permissions.get(5).getPermissionLevel()), "0");
		assertEquals(Integer.toString(int_permissions.get(6).getPermissionLevel()), "0");
		assertEquals(Integer.toString(int_permissions.get(7).getPermissionLevel()), "0");
		assertEquals(Integer.toString(int_permissions.get(8).getPermissionLevel()), "0");
		assertEquals(Integer.toString(int_permissions.get(9).getPermissionLevel()), "0");
	}
	...
	public void checkStringPermissionsLevel () {
		assertEquals(Integer.toString(string_permissions.get(0).getPermissionLevel()), "0");
		assertEquals(Integer.toString(string_permissions.get(1).getPermissionLevel()), "1");
		assertEquals(Integer.toString(string_permissions.get(2).getPermissionLevel()), "2");
		assertEquals(Integer.toString(string_permissions.get(3).getPermissionLevel()), "3");
		assertEquals(Integer.toString(string_permissions.get(4).getPermissionLevel()), "4");
		assertEquals(Integer.toString(string_permissions.get(5).getPermissionLevel()), "0");
		assertEquals(Integer.toString(string_permissions.get(6).getPermissionLevel()), "0");
		assertEquals(Integer.toString(string_permissions.get(7).getPermissionLevel()), "0");
		assertEquals(Integer.toString(string_permissions.get(8).getPermissionLevel()), "0");
		assertEquals(Integer.toString(string_permissions.get(9).getPermissionLevel()), "0");
	}
